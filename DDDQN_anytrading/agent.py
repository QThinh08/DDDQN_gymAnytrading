...
class Agent:
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims,
                 ...
                 replace=1000, algo=None, env_name=None, fc1_dims = 128, fc2_dims =128,
        ...
        self.q_eval = DuelingDeepQNetwork(input_dims, n_actions, fc1_dims, fc2_dims)
        self.q_eval.compile(optimizer=Adam(learning_rate=lr))
        self.q_next = DuelingDeepQNetwork(input_dims, n_actions, fc1_dims, fc2_dims)
